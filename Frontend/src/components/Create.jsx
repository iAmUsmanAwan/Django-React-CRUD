...
const Create = () => {
    ...
    const getData = async () => {
        try {
            const [countriesRes, leaguesRes, characteristicsRes] =
                await Promise.all([
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { setTouched }) => {
            ...
            axios_instance.post('footballclubs/', payload)
                .then((response) => {
                    // console.log("Form submitted successfully:", response.data);
                    setMessage(<Message messageText="Club created successfully!" messageColor="green" />);
                    setTimeout(() => {
                        navigate('/');
                    }, 2000);
                    // formik.resetForm();
                ...
                .catch((error) => {
                    ...
                    setMessage(<Message messageText="Error creating club. Please try again." messageColor="red" />);
                });
        }
